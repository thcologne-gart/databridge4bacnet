...
public class BacnetDatasinkConfiguration extends DataSinkConfiguration {
	...
	public BacnetDatasinkConfiguration() {}

	public BacnetDatasinkConfiguration(String uniqueId, String ipAddress, int deviceId, int objectType, int instanceNr, int propertyId) {
		super();
